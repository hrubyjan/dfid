...
public final class IDBProjectDetailsCrawler extends BaseDfidIncrementalPagedSourceHttpCrawler {
    ...
    private static final String SOURCE_URL = "http://www.iadb.org";
    private static final String RESULT_PAGE_URL_PATTERN = SOURCE_URL + "/en/projects/project-details,"
            + "1301.html?YearFrom=%1$s&YearTo=%1$s";
